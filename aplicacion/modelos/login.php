...
class Login extends BaseDeDatos {
    ...
    public function validarLogin($user,$pass,$id_dep) {
        $result=$this->conexion->query("SELECT * FROM usuarios WHERE usuario='$user' and password=sha1('$pass') and id_dep='$id_dep'");
