...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="publico/css/st-usuario.css">
...
<!--Logo de cbues-->
        <div class="logo">
            <img style="width: 100%;	margin-top: 5px; " src="publico/images/LOGO TRANSPARENTE CBUES.png" alt="">
        </div>
...
<!--Sidebar de opciones-->
        ...
        <a class="reportes" href="<?php  echo URL;?>reportesadministrador">
          <script src="https://cdn.lordicon.com/qjzruarw.js"></script>
          <lord-icon
...
<!--Imagenes del pie de la pagina de inicio-->
              <div id="thumbnail">
                <ul>
                  ...
                  <li style="color: white;">Manual de<br> "Agenda"<img src="https://taskntime.org/wp-content/uploads/2020/08/calendario6-1080x675.jpeg" alt="" /></li>
                    ...
                    <div class="row mb-3">
                        ...
                        <select class="form-control" name="provee" id="provee">
                            ...
                            // Verificamos la conexión con el servidor y la base de datos
                              $mysqli = new mysqli('localhost', 'root', 'catolica', 'cbues_agenda_compra');
                              $query = $mysqli -> query ("SELECT proveedores FROM proveedores ");
                ...
                <form id="formcompra" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <select class="form-control" name="proyecto" id="proyecto">
                            <option value="Sin definir">Actividad</option>
                            <?php
                            // Verificamos la conexión con el servidor y la base de datos
                              $mysqli = new mysqli('localhost', 'root', 'catolica', 'cbues_agenda_compra');
        ...
        <div class="slide" id="3">
          ...
          <div  id="contentFormProveedores" class="d-none">
                ...
                <form id="formProveedores" enctype="multipart/form-data">
                    <div class="row mb-3">
                        <label for="proveedores" class="col-sm-2 col-form-label">Proveedor: *</label>
                        <div class="col-sm-10">
...
<!--Agenda-->
          <div class="slide" id="4">
            <div class="content second-content">
              ...
              <div class="col-md-4">
                <div placeholder="Buscar registro" class="input-group mb-3">
                    <input type="search" class="form-control" aria-describedby="basic-addon2" id="txtSearchagenda">
                    <span class="input-group-text" id="basic-addon2">
                    <script src="https://cdn.lordicon.com/qjzruarw.js"></script>
                    <lord-icon
                          src="https://cdn.lordicon.com/xfftupfv.json"
...
<!--Scripts de inventario-->
  <script src="<?php echo URL?>publico/customjs/inven.js"></script>
    <script>
...
<!--Scripts de proveedores-->
    <script src="<?php echo URL?>publico/customjs/provee.js"></script>
    <script>
