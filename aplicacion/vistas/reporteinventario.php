...
<body>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container px-5">
                    <a class="navbar-brand" href="superreportes">Regresar a la selección de reportes</a>
                    <img width=200px style=" margin-top:-20px"  src="publico\images\LOGO TRANSPARENTE CBUES.png" alt="">
                    <a class="navbar-brand" href="supertablero">Regresar a la pagina principal </a>
                </div>
            </nav>
            ...
            <form  class="row gy-2 gx-3 align-items-center mt-2 mb-5">
                <div class="col-auto d-flex">
                    <label style="margin-top: 5px" for="principio">Desde:</label>
                    <input type="date" id="principio" name="principio">
                </div>

                <div class="col-auto d-flex">
                    <label style="margin-top: 5px" for="acaba">Hasta:</label>
                    <input type="date" id="acaba" name="acaba">
                </div>

                <div class="col-auto d-flex">
                    <label style="margin-top: 5px" for="comprador">Responsable:</label>
    ...
    <script src="<?php echo URL?>publico/customjs/reporteinventarios.js">
    </script>
</body>
</html>